 ...
 */
public class InsertGoal extends Fragment implements View.OnClickListener, CheckBox.OnCheckedChangeListener,HijriCalendarView.OnDateSetListener {
    Spinner s1, s2, s3;
    EditText from,to;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LinearLayout layout = (LinearLayout) v.findViewById(R.id.cheackbox);

        for (int i = 0; i < oName.length; i++) {
            btn[i] = new CheckBox(getContext()); // initialize it
            ...
            btn[i].setTextColor(getContext().getResources().getColor(R.color.text));
            btn[i].setId(2000 + i);
